...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202301051601-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2023 Jason Hempstead, Casjays Developments
# @@Created          :  Thursday, Jan 05, 2023 16:01 EST
# @@File             :  install.sh
# @@Description      :
...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/lenpaste"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="lenpaste"
INSTDIR="$HOME/.local/share/CasjaysDev/dockermgr/lenpaste"
APPDIR="$HOME/.local/share/srv/docker/lenpaste"
DATADIR="$HOME/.local/share/srv/docker/lenpaste/rootfs"
...
LENPASTE_USERNAME="${LENPASTE_USERNAME:-$DEFAULT_USERNAME}"
LENPASTE_PASSWORD="${LENPASTE_PASSWORD:-$DEFAULT_PASSWORD}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set container hostname and domain - Default lenpaste
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set this to 0.0.0.0 to listen on all or specific address
DEFINE_LISTEN=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
SET_USER_NAME="${CONTAINER_USER_NAME:-$LENPASTE_USERNAME}"
SET_USER_PASS="${CONTAINER_USER_PASS:-$LENPASTE_PASSWORD}"
